...
objArr['bonusWndText'].text= slotSpinResult.freeGamesWin +slotLanguage['counterBonusFreeMore'];	
	}else{
	objArr['bonusWndText'].text=slotSpinResult.freeGamesWin +slotLanguage['counterBonusFreeStart'];		
	}
};
