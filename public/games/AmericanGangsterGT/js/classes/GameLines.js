...
objArr[objId+"_back"].lineStyle(6, setObj['lnLine'+lnNum].back,1,1)
       .moveTo(cObj.segments[0].x, cObj.segments[0].y+0.2);
       
objArr[objId+"_front"].lineStyle(3, setObj['lnLine'+lnNum].front_c,1,1)
...
objArr[objId+"_back"].lineStyle(6, cObj.back,1,1)
       .moveTo(cObj.segments[0].x, cObj.segments[0].y+0.2);
       
objArr[objId].lineStyle(3, cObj.front_c,1,1)
       .moveTo(cObj.segments[0].x, cObj.segments[0].y);
